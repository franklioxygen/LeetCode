...
var removeObstacle = function (numRows, numColumns, lot) {
    ...
    while (res == 0) {
        ...
        for (point of twoS) {
            if (point[0] - 1 > -1 && point[0] + 1 < lot[0].length && point[1] - 1 > -1 && point[1] + 1 < lot.length)
                if (lot[point[0] - 1][point[1]] == 9 || lot[point[0] + 1][point[1]] == 9 || lot[point[0]][point[1] - 1] == 9 || lot[point[0]][point[1] + 1] == 9) {
                    return step;
                }
